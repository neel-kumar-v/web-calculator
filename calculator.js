class Calculator {
    ...
    updateDisplay() {
        ...
        if(this.operation != null) {
            this.previousOperandTextElement.innerText = this.getDisplayNumber(this.previousOperand) + ' ' + this.operation.toString()
        }
...
const calculatorElement = document.getElementById("calculator-grid")
function sideBar() {
